...
const Jumbotron = () => {
  return (
    <section id="jumbotron" className="w-full h-[22rem] pt-[44px] bg-gradient-to-l from-strong-pink to-soft-pink ">
      <div className="container flex w-full pl-20 pr-16">
        <div className="py-14">
        ...
        <div className="ml-16 relative py-10">
          <img className="absolute top-7 -left-6" src="/public/images/gambar-depan.png" alt="gambar-depan" />
          <img src="/public/images/gambar-belakang.png" alt="gambar-belakang" />
        </div>
      </div>
    </section>
  );
