      ...
      <div className="container font-avenir my-auto block w-[416px] h-[543px] shadow-slate-400 shadow-lg">
        <div className="w-[416px] mt-0 h-[490px] overflow-y-auto pt-[50px]">
          <form action="">
            ...
            <select className="block mx-auto w-[350px] h-[50] mb-8 text-2xl border-2 border-soft p-2 text-slate-600 bg-white rounded-md">
            ...
            <textarea id="address" name="address" className="block mx-auto w-[350px] h-[200px] mb-16 text-2xl text-slate-600 border-2 border-soft p-2 placeholder-soft rounded-md" placeholder="Alamat"></textarea>
